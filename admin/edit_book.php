		...
		<div class="row">
			...
			<div class="col-md-4">
				<form action="" method="post">
					...
					<div class="form-group">
						<label for="mobile">No Of Copies:</label>
						<input type="text" name="No_Of_Copies" value="<?php echo $No_Of_Copies;?>" class="form-control" required>
					</div>
...
<?php
	if(isset($_POST['update'])){
		$connection = mysqli_connect("localhost","root","");
		$db = mysqli_select_db($connection,"lms");
		$query = "update books set book_name = '$_POST[book_name]',author_id = $_POST[author_id],cat_id = $_POST[cat_id],book_price = $_POST[book_price],No_Of_Copies = $_POST[No_Of_Copies] where book_no = $_GET[bn]";
		$query_run = mysqli_query($connection,$query);
